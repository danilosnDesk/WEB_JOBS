...
export const Especific = () => {
    return (
        <section className="bg-[#b4cbf8]">
            <div className="bg-[url('/GroupXL.png')] bg-cover px-20 py-10 pb-[1rem] h-auto">
                ...
                <div className="flex flex-col flex-wrap items-center md:flex-row justify-center mt-[76px] ">
